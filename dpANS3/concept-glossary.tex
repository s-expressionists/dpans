...
\gentry{dynamic variable} \Noun\
  ...
  See the \term{declaration} \declref{special}.
...
\displaythree{Standardized I/O Customization Variables}{
*debug-io*&*error-output*&*query-io*\cr
...
\gentry{internal time unit} \Noun\ 
  ...
  See the \term{constant variable} \conref{internal-time-units-per-second}.
...
\gentry{pretty printing stream} \Noun\ 
  ...
  \themacro{pprint-logical-block} as a link between the output stream 
...
\gentry{safe} \Adjective\ 
  1. (of \term{code})
     ...
     See the \term{declaration} \declref{optimize}.
