...
\param{number}---a \typeref{real}.

\param{divisor}---a non-zero \typeref{real}.
...
\tablefigtwo{Bit-Wise Logical Operations}{Op}{Result}{
 \conref{boole-1}     & \param{integer-1}                                          \cr
 \conref{boole-2}     & \param{integer-2}                                          \cr
 \conref{boole-andc1} & and complement of \param{integer-1} with \param{integer-2} \cr
 \conref{boole-andc2} & and \param{integer-1} with complement of \param{integer-2} \cr
 \conref{boole-and}   & and                                                        \cr
 \conref{boole-c1}    & complement of \param{integer-1}                            \cr
 \conref{boole-c2}    & complement of \param{integer-2}                            \cr
 \conref{boole-clr}   & always 0 (all zero bits)                                   \cr
 \conref{boole-eqv}   & equivalence (exclusive nor)                                \cr
 \conref{boole-ior}   & inclusive or                                               \cr
 \conref{boole-nand}  & not-and                                                    \cr
 \conref{boole-nor}   & not-or                                                     \cr
 \conref{boole-orc1}  & or complement of \param{integer-1} with \param{integer-2}  \cr
 \conref{boole-orc2}  & or \param{integer-1} with complement of \param{integer-2}  \cr
 \conref{boole-set}   & always -1 (all one bits)                                   \cr
 \conref{boole-xor}   & exclusive or                                               \cr
}
}
