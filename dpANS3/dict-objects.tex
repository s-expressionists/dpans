...
\code
 (slot-missing (class-of \param{instance})
               \param{instance}
               \param{slot-name}
               'slot-boundp)
\endcode
...
\param{object}---an \term{object}. % TODO \param{instance} in similar functions
...
%%% ========== SLOT-VALUE
\begincom{slot-value}\ftype{Accessor}
...
\param{object}---an \term{object}. % TODO often called instance in
                                % similar functions
...
\code
 (slot-missing (class-of \param{object})
               \param{object}
               \param{slot-name}
               'slot-value)
\endcode
...
\auxbnf{slot-specifier}{\param{slot-name} |
                        (\param{slot-name}                         
                         \begininterleave\down{\param{slot-option}}\endinterleave)}
\auxbnf{slot-name}{\term{symbol}}
\auxbnf{slot-option}{\star{\curly{\kwd{reader}        \param{reader-function-name}}} | \CR
                     \star{\curly{\kwd{writer}        \param{writer-function-name}}} | \CR
                     \star{\curly{\kwd{accessor}      \param{reader-function-name}}} | \CR
                           \curly{\kwd{allocation}    \param{allocation-type}}       | \CR
                     \star{\curly{\kwd{initarg}       \param{initarg-name}}}         | \CR
                           \curly{\kwd{initform}      \param{form}}                  | \CR
                           \curly{\kwd{type}          \param{type-specifier}}        | \CR
                           \curly{\kwd{documentation} \term{string}}}
\auxbnf{function-name}{\curly{\term{symbol} | {\tt (setf \term{symbol})}}}
\auxbnf{class-option}{(\kwd{default-initargs} \f{.} \param{initarg-list}) | \CR
                      (\kwd{documentation} \term{string})                 | \CR
                      (\kwd{metaclass} \param{class-name})}
...
\param{class-name}---a \term{non-nil} \term{symbol}. % TODO repeated?
...
The \declref{special}, \declref{ftype}
...
will mention \keyref{key} (but no keyword
...
\param{args}---\term{objects} to be used as arguments to the next method.  
