...
\param{results}---if a \macref{return} or \specref{return-from} form is executed,
...
{\typeref{fixnum} | \typeref{float} | \typeref{t} | \typeref{nil}}
...
Except that \macref{loop-finish} cannot be used within a simple \macref{loop} \term{form},
...
This permits execution of any \loopref{finally} clause (for effect)
and
%% Per X3J13. -kmp 05-Oct-93
%then returns
the return of
