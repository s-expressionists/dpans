...
\OUT AREF requires its second argument to be of type INTEGER,
\OUT but it was called with an argument of type VECTOR.
\EV NIL
 (type-clash-error 'car 1 1 'list 'short-float)
\OUT CAR requires its argument to be of type LIST,
\OUT but it was called with an argument of type SHORT-FLOAT.
\EV NIL
\endcode
